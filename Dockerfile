...
RUN pip install --upgrade pip \
    ...
    face_recognition \
    Pillow \
    dlib  # Ensure CUDA support for dlib if available
...
# Copy the app and image data into the container
COPY img/document/a /app/img/document/a
COPY img/document/b /app/img/document/b
